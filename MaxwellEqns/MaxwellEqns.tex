...
\begin{frame}{Скін-ефект}{Якісне пояснення}
	...
	\begin{columns}
		...
		\begin{column}{0.7\linewidth}
			\begin{block}{}\justifying
				Змінний струм у провіднику породжує змінне \textcolor{blue}{вихрове магнітне поле}, силові лінії якого перпендикулярні до осі провідника. Змінне
				...
				струм спрямований у напрямку струму провідника, а всередині провідника --- протилежно. Це явище знижує струм у серцевині провідника і збільшує
				поверхневий струм.
			\end{block}
		\end{column}
	\end{columns}
...
\begin{frame}{Скін-ефект}{Рівняння скін-ефекту}
	...
	\framesubtitle<2>{Рівняння Максвелла для провідників у швидкозмінних полях}
