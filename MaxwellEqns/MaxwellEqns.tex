...
\begin{frame}{Зарядка конденсатора}{}\small
	...
	\begin{overprint}
		...
		\begin{block}{}\justifying
			...
			\[
				\frac{dW}{dt} = \Pi \cdot 2 \pi R h = \frac{1}{\varepsilon \pi R^2} \cdot q \dot{q} \cdot 2 \pi R h = \frac{q \dot{q}}{C},
			\]
...
\begin{onlyenv}<1>
	\begin{columns}
		...
		\begin{column}{0.7\linewidth}
			\begin{block}{}\justifying
				Знайдемо циркуляцію вектора \textcolor{red}{$\Efield$} вздовж контура
				\textcolor{green!60!black}{$L$}. За законом електромагнітної індукції:
				\begin{equation*}
		...
		\begin{columns}
			...
			\begin{column}{0.5\linewidth}\scriptsize
				...
				\begin{tikzpicture}[]
					...
					\end{loglogaxis}
					\node[anchor=north] at (2, -0.55) {\input{tikz/skin.tikz}};
				\end{tikzpicture}
			\end{column}
		\end{columns}
	\end{onlyenv}
