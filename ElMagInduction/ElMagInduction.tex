...
\begin{frame}{Пондеромоторні сили в магнітному полі}{}
	...
	\begin{onlyenv}<1>
		\begin{block}{}\justifying
			Відповідно до \alert{закону збереження енергії} робота, яку
			виконують джерела струму, йде на теплоту, на збільшення магнітної енергії системи і на механічну роботу ро переміщенню осердя:
			\begin{equation*}
