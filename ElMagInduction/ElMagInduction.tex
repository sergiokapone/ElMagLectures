	...
	\begin{columns}
		\begin{column}{0.5\linewidth}\centering
			\begin{tikzpicture}[rotate=90, scale=0.9, >=latex, midarrow/.style={%
				...
				\draw[red!40, ultra thick] ({1.1+0.3},0) circle(0.3 and 1);
				\foreach \y in {-3,...,3}{
						\draw[blue, midarrow] plot[domain=1:3] (\x, 0.2*\y+0.05*\y*\x^2);
					}
				\node[blue, font=\small] at (3.5, 0) {$\frac{d\Phi}{dt}>0$};
				\draw[arrowpos={0.5}{2pt}{7pt}, red!40, ultra thick] ({1.1+0.3},0) ++(90:1) arc(90:270:0.3 and 1);
			\end{tikzpicture}
		\end{column}
		\begin{column}{0.5\linewidth}\centering
			\begin{tikzpicture}[rotate=90, scale=0.9, >=latex, midarrow/.style={%
				...
				\node[blue, font=\small] at (3.5, 0) {$\frac{d\Phi}{dt}<0$};
				\draw[arrowpos={0.5}{2pt}{7pt}, red!40, ultra thick] ({1.1+0.3},0) ++(270:1) arc(270:90:0.3 and 1);
			\end{tikzpicture}
		\end{column}
	\end{columns}
...
\begin{frame}{Струми Фуко}{}
	...
	\end{block}
	\begin{block}{}
		\href{https://youtu.be/MglUIiBy2lQ}{Відео-демонстрація струмів Фуко}
	\end{block}
\end{frame}
% ===========================================================================
