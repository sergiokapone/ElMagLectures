...
\begin{frame}{Пондеромоторні сили в магнітному полі}{}
	\begin{columns}
		...
		\begin{column}{0.6\linewidth}
			\begin{block}{}\justifying
				Обмежимося випадком, коли система складається з двох
				контурів зі струмами $I_1$ і $I_2$. Магнітна енергія такої системи:
				\begin{equation*}
					W = \frac1{2c} (I_1\Phi_1 + I_2\Phi_2)
				\end{equation*}
			\end{block}
		\end{column}
	\end{columns}
	\begin{block}{}\justifying
		Відповідно до закону збереження енергії робота, яку
		виконують джерела струму, включені в контури $1$ і $2$, йде на
		теплоту, на збільшення магнітної енергії системи і на механічну роботу внаслідок переміщення або деформації контурів):
		\begin{equation*}
