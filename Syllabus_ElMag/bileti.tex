...
\addtocounter{bilets}{18}
\begin{bilet}%
\item Електростатичне поле: визначення, характеристики. Напруженість електричного поля: фізичний зміст, способи обчислення. Принцип суперпозиції
електростатичного поля. Силові лінії.
\item Сила Ампера та сила Лоренца. Сили, що діють на елементи струму в магнітному полі. Досліди Ампера.
\end{bilet}

\begin{bilet}%
\item Градієнт: визначення, фізичний зміст. Дивергенція: властивості та застосування, теорема Остроградського-Гаусса. Ротор: визначення, застосування у
фізиці, теорема Стокса.
\item Закон Ома у інтегральній та диференціальній формі. Закони Кірхгофа.
\end{bilet}
