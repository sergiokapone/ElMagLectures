...
Стаття Ейнштейна <<\emph{\color{blue}До електродинаміки рухомих тіл}>> ({\href{https://onlinelibrary.wiley.com/doi/10.1002/andp.19053221004}{Einstein A.
Zur Electrodynamik bewegter K{\"o}rper Annalen der Physik, 322, 891-921, 1905.}}) окреслила засади спеціальної теорії відносності.
\end{block}
	\begin{columns}
		...
		\begin{column}{0.5\linewidth}\centering
				\begin{tikzpicture}[pencildraw/.style={ %
					...
					\node[align=center,
						preaction={fill=black,opacity=.5}, font=\tiny, align=justify,
						pencildraw,draw,fill=white,text width=0.9\linewidth,inner sep=2mm]
					{
                            {\hfill\bfseries До електродинаміки рухомих тіл\hfill}

                            {\hfill\bfseries Автор: А. Ейнштейн\hfill}

                            {\hfill --- \hfill}

             				\hspace*{2em}Відомо, що {\color{red}електродинаміка Максвелла --- в сучасному її вигляді --- у застосуванні до рухомих тіл
             				приводить до асиметрії, яка невластива самим явищам}. Пригадаємо, наприклад, електродинамічну взаємодія між магнітом та
             				провідником зі струмом. {\color{red}Спостережуване явище залежить лише від відносного руху провідника і магніту, тоді як,
             				згідно з звичайним уявленням, два випадки, у яких рухається або одне, або інше з цих тіл, повинні бути строго розмежовані}.
             				Справді, {\color{blue}якщо рухається магніт, а провідник знаходиться в спокої, то навколо магніту виникає електричне поле},
             				що має деяку кількість енергії, яке в тих місцях, де знаходяться частини провідника, породжує струм. {\color{blue}Якщо ж
             				магніт перебуває у спокої, а рухається провідник, навколо магніту немає ніякого електричного поля}; натомість у провіднику
             				виникає електрорушійна сила, якій самій по собі не відповідає ніяка енергія, але яка --- за умови передбачуваної тотожності
             				відносного руху в обох випадках, --- викликає електричні струми тієї ж величини і того ж напрямку, що й
             				електричне поле в першому випадку.
                    };
				\end{tikzpicture}
		\end{column}
	\end{columns}
\begin{columns}
	\begin{column}{0.5\linewidth}
        \begin{block}{}\justifying
             Аліса та Боб, які вважаються себе нерухомими, можуть по різному трактувати причину виникнення електричного струму в провіднику, що тримає
             Аліса.
        \end{block}
	\end{column}
	\begin{column}{0.5\linewidth}
...
%	\node[anchor=south west, opacity=0.5] at
%	(current page.south west) {
%\includegraphics[width=\linewidth]{special-theory-of-relativity}
%};}
...
%, основні постулати якої:
%
%                    \medskip
%
%					--- В усіх інерціальних системах відліку фізичні процеси відбуваються однаково, тобто \alert{
%						      закони, що описують ці процеси мають однаковий вигляд  в усіх інерціальних системах відліку.}
%                    \medskip
%
...
\begin{frame}{Просторово-часові поняття}{}
	\begin{block}{}\small\justifying
		...
		З міркувань наочності користуються \emph{\color{blue}чотиривимірним простором}, на осях якого відкладаються три просторові координати і час. В цьому просторі подія зображується точкою $ (ct, x, y, z) $. Ця точка називаються \emph{\color{blue}світовою точкою}.
	...
	\begin{minipage}{0.62\linewidth}\footnotesize
		...
		\alert{Перетворення Лоренца для координат та часу --- це перетворення координат 4-радіус-вектора.}
...
%------------------------------------------------------------------------------
\section{Електродинаміка Лоренца}
%------------------------------------------------------------------------------
