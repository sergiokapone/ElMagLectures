...
\begin{frame}{Магнетики}{}\small
	\begin{block}{}\justifying
		...
		\begin{enumerate}
			\item Якщо $\chi_m > 0$, $\mu > 1$, то речовина називається \alert{парамагнетиком}. Парамагнітні властивості мають, наприклад, \ce{Al}, \ce{Pt},
			      \ce{FeCl2}, \ce{O2}, лужні та лужноземельні метали.
			\item Якщо $\chi_m < 0$, $\mu < 1$, то речовина називається \alert{діамагнетиком}. Діамагнетиком є \ce{Bi}, \ce{Sb}, \ce{Si}, \ce{H2O}, \ce{H2},
			      \ce{N2} тощо.
		\end{enumerate}
