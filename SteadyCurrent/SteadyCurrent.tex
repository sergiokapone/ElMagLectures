...
% ============================== Слайд ## ===================================
\begin{frame}{Означення}{Сила та густина струму}
...
\begin{frame}{Означення}{Густина струму та густина заряду}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.3\linewidth}\centering
			\input{tikz/electronCyllinder.tikz}
		\end{column}
	\end{columns}
	\begin{block}{}
...
\begin{frame}{Закон збереження заряду}{}
	\begin{columns}
		...
		\begin{column}{0.3\linewidth}
			\input{tikz/chargeConservation.tikz}
		\end{column}
	\end{columns}
	\begin{overprint}
		\onslide<1>
...
% ============================== Слайд ## ===================================
\begin{frame}{Закон Ома}{Диференціальна форма}
	\begin{columns}
		\begin{column}{0.7\linewidth}
			\begin{block}{}\justifying
...
% ============================== Слайд ## ===================================
\begin{frame}{Теорія провідності металів Друде}{}
	\begin{block}{}\justifying\small
...
\begin{frame}{Температурна залежність опору}{}
	\begin{columns}
		\begin{column}{0.3\linewidth}\centering
			\begin{figure}
				\input{tikz/DrudeRho.tikz}
				\caption{Теорія Друде}
			\end{figure}
		\end{column}
		\begin{column}{0.3\linewidth}\centering
			\begin{figure}
				\input{tikz/ExpRho.tikz}
				\caption{Експеримент}
			\end{figure}
		\end{column}
		\begin{column}{0.3\linewidth}
...
\begin{frame}{Сторонні сили}{}
	\begin{columns}
		\begin{column}{0.4\linewidth}\centering
			\input{tikz/CurrentSpheres.tikz}
		\end{column}
